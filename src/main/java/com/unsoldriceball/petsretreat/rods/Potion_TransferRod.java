...
public class Potion_TransferRod extends Potion
{
    public static final String ID_POTION = "pettransferrodpotion";
    final ResourceLocation ICON = new ResourceLocation(ID_MOD, "textures/gui/" + ID_POTION + ".png");




    public Potion_TransferRod(String name, boolean isBadEffectIn, int liquidColorIn, int iconIndexX, int iconIndexY)
    {
